export const metadata = { title: "Регистрация / ликвидация — Услуги" };

const bullets = ["Подбор ОКВЭД и налогового режима", "Подготовка документов ИП/ООО", "Подача и взаимодействие с ФНС", "Постановка учёта/банка/онлайн-кассы", "Сопровождение ликвидации ИП/ООО"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">Регистрация / ликвидация</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Сопровождаю запуск и завершение бизнеса без бюрократии.
      </p>
