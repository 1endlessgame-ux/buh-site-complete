export const metadata = { title: "3-НДФЛ и вычеты — Услуги" };

const bullets = ["Сбор и проверка документов", "Заполнение декларации 3-НДФЛ", "Вычеты: имущественные, социальные, инвестиционные", "Работа с отчётами брокеров", "Подача и контроль статуса"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">3-НДФЛ и вычеты</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Готовлю декларации и сопровождаю получение вычетов.
      </p>
