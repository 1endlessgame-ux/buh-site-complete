export const metadata = { title: "Консалтинг и правовые вопросы — Услуги" };

const bullets = ["Разбор договоров и первички", "Разработка учётной политики", "Оптимизация налогообложения (в рамках закона)", "Внедрение 1С и онлайн-сервисов", "Сопровождение проверок"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">Консалтинг и правовые вопросы</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Точечная помощь и сопровождение по финансово-правовым вопросам.
      </p>
