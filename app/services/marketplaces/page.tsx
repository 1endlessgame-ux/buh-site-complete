export const metadata = { title: "Маркетплейсы — Услуги" };

const bullets = ["Разбор агентских отчётов и комиссий площадки", "Учёт возвратов, эквайринга и логистики", "Подбор режима налогообложения", "Подготовка и сдача отчётности", "Автоматизация обмена данными"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">Маркетплейсы</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Помогаю предпринимателям на маркетплейсах разобраться с отчётами и налогами.
      </p>
