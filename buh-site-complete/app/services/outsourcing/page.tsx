export const metadata = { title: "Бухгалтерское обслуживание / аутсорсинг — Услуги" };

const bullets = ["Ведение бухгалтерского и налогового учёта", "Кадровый учёт и расчёт зарплаты/взносов", "Подготовка и сдача отчётности (ФНС, фонды)", "Взаимодействие с банками и контрагентами, сверки", "Консультации по учётной политике и оптимизации"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">Бухгалтерское обслуживание / аутсорсинг</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Полный цикл ведения учёта и отчётности для ИП и ООО.
      </p>
