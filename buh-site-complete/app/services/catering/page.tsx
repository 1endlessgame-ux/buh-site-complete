export const metadata = { title: "Общепит — Услуги" };

const bullets = ["Калькуляции блюд и учёт себестоимости", "Складской учёт и инвентаризации", "Учёт выручки, эквайринг, онлайн-касса", "Взаиморасчёты с поставщиками, учёт ТМЦ", "Отчётность и налоги без штрафов"];

export default function Page() {
  return (
    <section className="py-12 md:py-16">
      <a href="/services" className="text-sm text-blue-600 dark:text-blue-400">← Ко всем услугам</a>
      <h1 className="mt-2 text-3xl font-semibold">Общепит</h1>
      <p className="mt-3 text-neutral-600 dark:text-neutral-300 max-w-2xl">
        Кафе, рестораны, кофейни: строим управленческий и бухгалтерский контур.
      </p>
